...
class PurchaseTest extends TestCase
{
    ...
    /** @test */
    public function can_not_store_a_purchase_if_the_product_not_exists()
    {
    ...
    /** @test */
    public function can_not_store_a_purchase_if_the_provider_not_exists()
    {
        $product = Product::factory()->create();
    ...
    /** @test */
    public function can_not_store_a_purchase_if_the_quantity_is_null()
    {
        $product = Product::factory()->create();
        $provider = Provider::factory()->create();
    ...
    /** @test */
    public function can_not_store_a_purchase_if_the_quantity_is_not_numeric()
    {
        $product = Product::factory()->create();
        $provider = Provider::factory()->create();
    ...
    /** @test */
    public function can_not_store_a_purchase_if_the_price_is_null()
    {
        $product = Product::factory()->create();
        $provider = Provider::factory()->create();
    ...
    /** @test */
    public function can_not_store_a_purchase_if_the_price_is_not_numeric()
    {
        $product = Product::factory()->create();
        $provider = Provider::factory()->create();
